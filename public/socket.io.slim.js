...
}(this, function ()
{
    ...
    }([function (t, e, r)
    {
        ...
        function n(t, e)
        {
            ...
            var r, n = i(t), s = n.source, h = n.id, p = n.path, u = c[h] && p in c[h].nsps,
                f = e.forceNew || e["force new connection"] || !1 === e.multiplex || u;
            return f ? r = a(s, e) : (c[h] || (c[h] = a(s, e)), r = c[h]), n.query && !e.query && (e.query = n.query), r.socket(n.path, e)
        }
        ...
        t.exports = e = n;
        var c = e.managers = {};
        e.protocol = s.protocol, e.connect = n, e.Manager = r(10), e.Socket = r(34)
    }, function (t, e, r)
    {
        (function (e)
        {
            ...
            function n(t, r)
            {
                ...
                var i = n.host.indexOf(":") !== -1, s = i ? "[" + n.host + "]" : n.host;
    ...
    }, function (t, e, r)
    {
        ...
        {
            var r = "" + t.type;
            return e.BINARY_EVENT !== t.type && e.BINARY_ACK !== t.type || (r += t.attachments + "-"), t.nsp && "/" !== t.nsp && (r += t.nsp + ","), null != t.id && (r += t.id), null != t.data && (r += JSON.stringify(t.data)), r
        }
        ...
        function i(t, e)
        {
            function r(t)
            {
                var r = l.deconstructPacket(t), n = o(r.packet), i = r.buffers;
                i.unshift(n), e(i)
            }
        ...
        function a(t)
        {
            var r = 0, n = {type: Number(t.charAt(0))};
        ...
        var u = (r(3)("socket.io-parser"), r(5)), f = r(6), l = r(8), d = r(9);
        ...
        {
            if (t.type !== e.EVENT && t.type !== e.ACK || !f(t.data) || (t.type = t.type === e.EVENT ? e.BINARY_EVENT : e.BINARY_ACK), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type) i(t, r); else
            {
                var n = o(t);
                r([n])
            }
        ...
        {
            var r;
            if ("string" == typeof t) r = a(t), e.BINARY_EVENT === r.type || e.BINARY_ACK === r.type ? (this.reconstructor = new h(r), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", r)) : this.emit("decoded", r); else
            {
    ...
    }, function (t, e, r)
    {
        (function (e)
        {
            function n(t)
            {
                ...
                if (o(t))
                {
                    for (var r = 0, i = t.length; r < i; r++) if (n(t[r])) return !0;
                    return !1
                }
                ...
                for (var c in t) if (Object.prototype.hasOwnProperty.call(t, c) && n(t[c])) return !0;
                return !1
            }

            var o = r(7), i = Object.prototype.toString,
    ...
    }, function (t, e, r)
    {
        (function (t)
        {
            ...
            function o(t, e)
            {
                ...
                if (i(t)) for (var r = 0; r < t.length; r++) t[r] = o(t[r], e); else if ("object" == typeof t) for (var n in t) t[n] = o(t[n], e);
                return t
            }

            var i = r(7), s = r(9), a = Object.prototype.toString,
            ...
            }, e.removeBlobs = function (t, e)
            {
                function r(t, a, p)
                {
                    ...
                    } else if (i(t)) for (var f = 0; f < t.length; f++) r(t[f], f, t); else if ("object" == typeof t && !s(t)) for (var l in t) r(t[l], l, t)
                }
    ...
    }, function (t, e, r)
    {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t)
            ...
            {
                return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
            }, i = r(11), s = r(34), a = r(5), c = r(4), h = r(36), p = r(37),
            u = (r(3)("socket.io-client:manager"), r(33)), f = r(38), l = Object.prototype.hasOwnProperty;
        ...
        }, n.prototype.open = n.prototype.connect = function (t, e)
        {
            ...
            if (!1 !== this._timeout)
            {
                var a = this._timeout, c = setTimeout(function ()
                {
    ...
    {
        t.exports = r(12), t.exports.parser = r(19)
    }, function (t, e, r)
    {
        (function (e)
        {
            ...
            var i = r(13), s = r(5), a = (r(3)("engine.io-client:socket"), r(33)), c = r(19), h = r(2), p = r(27);
            t.exports = n, n.priorWebsocketSuccess = !1, s(n.prototype), n.protocol = c.protocol, n.Socket = n, n.Transport = r(18), n.transports = r(13), n.parser = r(19), n.prototype.createTransport = function (t)
            {
                var e = o(this.query);
            ...
            }, n.prototype.probe = function (t)
            {
                function e()
                {
                    ...
                    p || (h.send([{type: "ping", data: "probe"}]), h.once("packet", function (t)
                    {
                        if (!p) if ("pong" === t.type && "probe" === t.data)
                        {
                            ...
                            {
                                p || "closed" !== u.readyState && (c(), u.setTransport(h), h.send([{type: "upgrade"}]), u.emit("upgrade", h), h = null, u.upgrading = !1, u.flush())
                            })
                        } else
                        {
                ...
                function c()
                {
                    h.removeListener("open", e), h.removeListener("error", o), h.removeListener("close", i), u.removeListener("close", s), u.removeListener("upgrading", a)
                }

                var h = this.createTransport(t, {probe: 1}), p = !1, u = this;
                n.priorWebsocketSuccess = !1, h.once("open", e), h.once("error", o), h.once("close", i), this.once("close", s), this.once("upgrading", a), h.open()
            }, n.prototype.onOpen = function ()
            {
                if (this.readyState = "open", n.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t])
    ...
    }, function (t, e, r)
    {
        (function (t)
        {
            function n(e)
            {
                ...
                if (t.location)
                {
                    var h = "https:" === location.protocol, p = location.port;
            ...
            var o = r(14), i = r(16), s = r(30), a = r(31);
    ...
    }, function (t, e, r)
    {
        (function (e)
        {
            ...
            var a = r(14), c = r(17), h = r(5), p = r(28);
                ...
                try
                {
                    ...
                    }) : r.onreadystatechange = function ()
                    {
                        if (2 === r.readyState)
                        {
                            ...
                            "application/octet-stream" === t && (r.responseType = "arraybuffer")
                        }
    ...
    }, function (t, e, r)
    {
        (function (t)
        {
            ...
            var h, p = r(20), u = r(6), f = r(21), l = r(22), d = r(23);
            ...
            var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = p(v),
                k = {type: "error", data: "parser error"}, w = r(26);
            e.encodePacket = function (e, r, i, a)
            {
                ...
                var h = v[e.type];
                return void 0 !== e.data && (h += i ? d.encode(String(e.data), {strict: !1}) : String(e.data)), a("" + h)
            ...
            {
                var r = b[t.charAt(0)];
                if (!h) return {type: r, data: {base64: !0, data: t.substr(1)}};
    ...
    }, function (t, e, r)
    {
        ...
        (function (t, o)
        {
            !function (i)
            {
                ...
                function a(t)
                {
                    for (var e, r = t.length, n = -1, o = ""; ++n < r;) e = t[n], e > 65535 && (e -= 65536, o += k(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += k(e);
                    return o
                }
                ...
                function p(t, e)
                {
                    ...
                    var r = "";
                    return 0 == (4294965248 & t) ? r = k(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (c(t, e) || (t = 65533), r = k(t >> 12 & 15 | 224), r += h(t, 6)) : 0 == (4292870144 & t) && (r = k(t >> 18 & 7 | 240), r += h(t, 12), r += h(t, 6)), r += k(63 & t | 128)
                }
                ...
                function l(t)
                {
                    ...
                    if (240 == (248 & e) && (r = f(), n = f(), o = f(), i = (7 & e) << 18 | r << 12 | n << 6 | o, i >= 65536 && i <= 1114111)) return i;
                ...
                var g, v, b, k = String.fromCharCode, w = {version: "2.1.2", encode: u, decode: d};
                n = function ()
                {
                    return w
    ...
    }, function (t, e)
    {
        !function ()
        {
            ...
            {
                var e, n, o, i, s, a = .75 * t.length, c = t.length, h = 0;
                "=" === t[t.length - 1] && (a--, "=" === t[t.length - 2] && a--);
                var p = new ArrayBuffer(a), u = new Uint8Array(p);
    ...
    }, function (t, e, r)
    {
        (function (e)
        {
            ...
            var o, i = r(18), s = r(19), a = r(27), c = r(28), h = r(29),
    ...
    }, function (t, e, r)
    {
        ...
        {
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, i = r(4), s = r(5), a = r(35), c = r(36), h = r(37), p = (r(3)("socket.io-client:socket"), r(27));
        t.exports = e = n;
        var u = {
            connect: 1,
            connect_error: 1,
        ...
        s(n.prototype), n.prototype.subEvents = function ()
        {
            ...
            {
                var t = this.io;
                this.subs = [c(t, "open", h(this, "onopen")), c(t, "packet", h(this, "onpacket")), c(t, "close", h(this, "onclose"))]
            }
        ...
        }, n.prototype.emit = function (t)
        {
            ...
            var e = a(arguments), r = {type: i.EVENT, data: e};
        ...
        {
            var e = t.data || [];
            null != t.id && e.push(this.ack(t.id)), this.connected ? f.apply(this, e) : this.receiveBuffer.push(e)
        }, n.prototype.ack = function (t)
        {
            ...
            return function ()
            {
                if (!r)
                {
                    r = !0;
                    var n = a(arguments);
                    e.packet({type: i.ACK, id: t, data: n})
                }
            }
